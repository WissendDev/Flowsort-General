...
### 🇺🇸 English Description
**FlowSort** is a smart context menu utility that instantly organizes cluttered folders into categories or sorted lists with a single right-click.

#### ✨ Key Features
* 🚀 **Shell Integration:** Works directly from the Right-Click menu.
* 🧠 **Smart Sort:** Automatically moves files into categories (Images, Video, Docs, etc.).
* 🔢 **Quick Ordering:** Instant sorting by name, size, or date.
...
### 🇷🇺 Описание на русском
**FlowSort** — это удобная утилита для контекстного меню, которая в один клик наводит идеальный порядок в папках, сортируя файлы по категориям или спискам.

#### ✨ Основные возможности
* 🚀 **Интеграция в систему:** Работает через меню правой кнопки мыши (ПКМ).
* 🧠 **Умная сортировка:** Автоматическое распределение по категориям (Картинки, Видео, Документы).
...
---
<p align="center">
  <i>Developed with ❤️ for clean workspaces.</i>
</p>
